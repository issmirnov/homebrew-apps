class Zap < Formula
  ...
  url "https://github.com/issmirnov/zap/releases/download/v0.9.7/zap_MacOS_64-bit.tar.gz"
  version "0.9.7"
  sha256 "701a8224643a003163b01c649fa0baccd9b1651a062eecf0959159bc59d8cd30"
