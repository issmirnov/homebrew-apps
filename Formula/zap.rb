class Zap < Formula
  ...
  url "https://github.com/issmirnov/zap/releases/download/v1.0.0/zap_MacOS_64-bit.tar.gz"
  version "1.0.0"
  sha256 "bc50a4a0687596b8f8a42a2a23de86627b9e4477bb56ca542d18cc1e239728a8"
